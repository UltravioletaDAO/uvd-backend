#!/usr/bin/env pwsh
# Script de despliegue automatizado para la función Lambda

$ErrorActionPreference = 'Stop'
Write-Host "=== INICIANDO DESPLIEGUE AUTOMATIZADO DE LAMBDA ==="
...
$KEY_NAME = "new-applicants/lambda.zip"
...
aws lambda update-function-code --function-name ultravioleta-new-applicants --s3-bucket $BUCKET_NAME --s3-key $KEY_NAME --region us-east-2
